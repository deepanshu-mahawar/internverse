...
const FeedbackHistory: React.FC = () => {
  ...
  const approvedProjects = projectsWithFeedback.filter(
    (p) => p.status === "approved"
  );

  const needsImprovementProjects = projectsWithFeedback.filter(
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          View all feedback you have provided to students
        </p>
      </div>
